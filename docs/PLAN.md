...
RepoTrust v1 CLI를 "로컬 저장소 신뢰 리포트 도구"로 안정화한다. 다음 개발은 샘플 fixture와 리포트 예시를 추가해 회귀 테스트와 문서 이해도를 높인다.

## 현재 우선순위

1. 샘플 저장소 fixture와 리포트 예시를 추가해 회귀 테스트와 문서 이해도를 높인다.
...
1. `샘플 fixture와 예시 리포트 추가`부터 시작한다.
