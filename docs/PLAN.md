...
RepoTrust v1 CLI를 "로컬 저장소 신뢰 리포트 도구"로 안정화한다. 다음 개발은 설치 안전성, 리포트 신뢰성, CLI 사용성을 순서대로 개선한다.

## 현재 우선순위

1. Install Safety rule을 더 현실적인 저장소 사례에 맞게 고도화한다.
...
1. `Install Safety 위험 패턴 확장`부터 시작한다.
