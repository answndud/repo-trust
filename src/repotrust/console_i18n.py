...
CONSOLE_TEXT: dict[str, ConsoleText] = {
    "en": {
        ...
        "no_json_reports_found": "No JSON reports found in result/. Type a path instead.",
        "number_column": "No.",
        "path_column": "Path",
        "type_column": "Type",
        ...
        "compare_saved_hint": "Use [R] Reports from Console Mode to find this file later.",
        ...
        "report_number_hint": "Enter a number from the list, or type a path.",
    ...
    "ko": {
        ...
        "no_json_reports_found": "result/에서 JSON 리포트를 찾지 못했습니다. 경로를 직접 입력하세요.",
        "number_column": "번호",
        "path_column": "경로",
        "type_column": "형식",
        "modified_column": "수정 시간",
        "json_report_type": "JSON 리포트",
        "html_report_type": "HTML 리포트",
        "compare_html_report_type": "비교 HTML",
        "markdown_report_type": "Markdown 리포트",
        "compare_saved_hint": "나중에 Console Mode의 [R] 리포트에서 이 파일을 다시 찾을 수 있습니다.",
        ...
        "report_number_hint": "목록의 번호를 입력하거나 경로를 직접 입력하세요.",
        "default_hint": "기본값",
