...
처음 사용하는 경우에는 이 메뉴에서 선택하는 방식이 가장 쉽습니다. 반복해서 쓰는 명령은 아래처럼 직접 입력하면 더 빠릅니다.

## 3. GitHub URL을 HTML로 저장
