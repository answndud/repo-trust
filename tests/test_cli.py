...
def test_cli_version():
    ...
    assert result.stdout.strip() == "repotrust 0.2.4"
...
def test_direct_cli_version():
    ...
    assert result.exit_code == 0
    assert result.stdout.strip() == "repo-trust 0.2.4"
...
def test_direct_kr_cli_version():
    ...
    assert result.exit_code == 0
    assert result.stdout.strip() == "repo-trust-kr 0.2.4"
...
def test_direct_cli_root_starts_interactive_launcher():
    ...
    assert "RepoTrust v0.2.4" in stderr
